...
const FAQ = {
  en: {
    client: [
      ...
      ["Are caregivers verified?", "Every caregiver listed has been reviewed by Kakatong before appearing in the directory — that's what the ✓ Verified badge means. We still encourage families to interview candidates and check references; our platform gives you the tools and reviews to do it well."],
  ...
  zh: {
    client: [
      ...
      ["照護者有經過驗證嗎？", "名錄中的每位照護者都經過家家通審核後才會顯示 — 這就是 ✓ 已驗證標章的意義。我們仍建議家庭親自面談並查核推薦人；平台提供評價與工具協助您做好把關。"],
  ...
  es: {
    client: [
      ...
      ["¿Los cuidadores están verificados?", "Cada cuidador listado fue revisado por Kakatong antes de aparecer — eso significa la insignia ✓ Verificado. Aun así recomendamos entrevistar y pedir referencias; la plataforma le da las herramientas y reseñas para hacerlo bien."],
